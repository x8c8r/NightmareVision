...
class Modifier
{
	...
	public function postUpdateReceptor(beat:Float, receptor:StrumNote, pos:Vector3, player:Int) {}
	
	public function postUpdateNote(beat:Float, note:Note, pos:Vector3, player:Int) {}
